...
public class Server {
    ...
    private int multicastPort = 6000; // Porta multicast
    ...
    public Server() throws IOException {
        ...
        this.converter = new Gson(); // Inizializza Gson per la conversione JSON
    }
    ...
    public void avvioServer() throws IOException {
        ...
        try {
            ...
            this.output = new PrintWriter(c.getOutputStream(), true); // Crea gli stream di input/output
        } catch (IOException e) {
            throw new RuntimeException(e);
        }
